...
The results above show the letters *O, F*, and *P* are the letters appearing consecutively most often. There may be a slight decrease in win percentage in puzzle that contain doubles letters. A  hypothesis test was performed to determine whether this decrease is significant.
...
+ **What is the effect of double letters?**
  ...
  - There is statistically significant evidence that puzzles with double letters are harder (p-value = 0.07284).
